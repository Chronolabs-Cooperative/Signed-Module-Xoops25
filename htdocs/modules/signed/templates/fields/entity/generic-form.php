...
<p style="font-size: 1.15em;">
	<center>
	<?php 
		echo $formHandler->getForm('entity', $form, 'entity-'.$form, _FORM_ENTITY_TITLE, _URL_ROOT . '/=generator=/' . (!$_SESSION["signed"]['configurations']['htaccess']?'':'index' . $_SESSION["signed"]['configurations']['htaccess_extension']), _FORM_ENTITY_SUMMARY);
	?>
	</center>
</p>