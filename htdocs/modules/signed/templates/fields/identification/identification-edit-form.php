...
<p style="font-size: 1.15em;">
	<center>
	<?php 
		echo $formHandler->getForm('identification', $form, $_SESSION["signed"]['step'].'-'.$form, sprintf(_FORM_IDENTIFICATION_TITLE, $identifications[$_SESSION["signed"]['step']]['title']), _URL_ROOT . '/=request=/'. (!$_SESSION["signed"]['configurations']['htaccess']?'':'index' . $_SESSION["signed"]['configurations']['htaccess_extension']), _FORM_IDENTIFICATION_SUMMARY);
