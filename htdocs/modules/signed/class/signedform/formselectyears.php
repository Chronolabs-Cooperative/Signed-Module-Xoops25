 ...
 */
class signedFormSelectYears extends xoopsFormElementTray
{
	var $value;
	var $name;
    /**
     ...
     */
    function signedFormSelectYears($caption, $name, $value = null)
    {
    ...
    function render()
    {
    	...
    	$option_select->addOptionArray(signedLists::getYearsList());
