 ...
 */
	...
	echo $GLOBALS['api']->format(array('success'=> true, 'banned' => array('hostname' => signedSecurity::getInstance()->getBannedHostnames(), 'ip' => signedSecurity::getInstance()->getBannedIP()), 'when' => time()));
