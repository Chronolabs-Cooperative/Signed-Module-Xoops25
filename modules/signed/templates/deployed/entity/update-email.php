...
?><?php
	...
	signedPackages::getInstance()->sealEditedPackage('entity');
	signedPackages::getInstance()->saveEditedEnsigmentPackage($_SESSION["signed"]['package']['serial-number'], $_SESSION["signed"]['package']);
	signedPackages::getInstance()->lodgeCallbackSessions($_SESSION["signed"]['package']['serial-number'], 'request');
