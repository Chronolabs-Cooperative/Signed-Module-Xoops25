...
<p style="font-size: 1.15em;">
	<center>
	<?php 
		echo $formHandler->getForm('personal', $form, 'personal-'.$form, _FORM_PERSONAL_TITLE, _URL_ROOT . '/=generator=/'. (!$_SESSION["signed"]['configurations']['htaccess']?'':'index' . $_SESSION["signed"]['configurations']['htaccess_extension']), _FORM_PERSONAL_SUMMARY);
	?>
	</center>
</p>